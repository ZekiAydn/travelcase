...
interface FilterSidebarProps {
    ...
    setFilters: (key: keyof FilterParams, value: string) => void; // Burada tür uyumluluğunu sağlıyoruz
    nightOptions: string[];
...
const FilterSidebar: React.FC<FilterSidebarProps> = ({ filters, setFilters, nightOptions, peopleOptions, filtersOpen, setFiltersOpen }) => {
    ...
    const [selectedDate, setSelectedDate] = useState(dayjs(filters.date));

    useEffect(() => {
        setFilters("date", selectedDate ? selectedDate.format("YYYY-MM-DD") : "");
    }, []);
